...
<html>
    <head>
        ...
        <title>Wereda Administrator</title>
        <link rel="stylesheet" href="css/sidebar.css">
        <script src="js/weredaadmin.js"></script>
    </head>
    <body>
        <%
            ...
            if (session.getAttribute("username") == null || !session.getAttribute("uType").equals("wereda_admin")) {
                response.sendRedirect("index.jsp");
            }
        %>
        <div class="sidenav">
            <h5 style="color: white; text-align: center">Services</h5>
            <a href="#" id="createAdm">Add new VE Registrants</a>
            <a href="#" id="mgtAdm">Manage VE Registrants</a>
        ...
        <div class="wrapper main">
            ...
            <div id="dRegAdm" style="display: none">
                <br>
                <div>
                    <form class="col-4 offset-4" action="RegRgt" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-8">
                                <select name="role" class="form-control">
                                    <option value="kebele_emp" selected>Kebele Employee</option>
                                    <option value="court_emp">Court Employee</option>
                                    <option value="hospital_emp">Hospital Employee</option>
                                </select>
                            </div>
                        </div><br>
                        <input type="text" name="adminname" value="${username}" hidden>
                        <input type="text" name="weburl" hidden value="weredaadmin.jsp">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <%  String region_id = session.getAttribute("regionID").toString();
                                ...
                                String wereda = session.getAttribute("wereda").toString();
                                Connection con = null;
                                Statement stmt = null;
                                ResultSet rs = null;
                                String data = "select * from mgt where region = " + region_id + " and zone = " + zone_id + " and wereda = " + "'" + wereda + "' and role != 'wereda_admin'";
                                con = DB.getConn();
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <form action="ChangeStatus" method="POST">
                                            ...
                                            <input type="text" name="weburl" value="weredaadmin.jsp" hidden>
