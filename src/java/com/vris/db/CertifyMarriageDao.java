...
public class CertifyMarriageDao {

    Connection con;
    PreparedStatement pstmt;
    String miniquery = "select * from marriage where marriage_reg_id=?";
    ...
    public String getMarriageInfo(String death_reg_id, String need) {
        String res = null;
        try {
            con = DB.getConn();
