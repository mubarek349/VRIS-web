...
public class CertifyDeathDao {

    Connection con;
    PreparedStatement pstmt;
    String miniquery = "select * from death where death_reg_id=?";
    ...
    public String getDeathInfo(String death_reg_id, String need) {
        String res = null;
        try {
            con = DB.getConn();
    ...
    public String getFullDeathPlace(int birth_place_id) {
