...
public class CertifyBirthDao {

    Connection con;
    PreparedStatement pstmt;
    String miniquery = "select * from birth where birth_reg_id=?";
    ...
    public String getChildInfo(String birth_reg_id, String need) {
        String childId = null;
        try {
            con = DB.getConn();
    ...
    public String getFullBirthPlace(int birth_place_id) {
