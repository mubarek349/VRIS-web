...
public class RegRgtDao {
    ...
    public boolean sendToDB(String fname, String mname, String lname, String username, String password, String role, String adminname) {
        boolean res = false;
        String encryptedPass = SCryptUtil.scrypt(password, 16, 16, 16);
        String region = getRegion(adminname);
        String zone = getZone(adminname);
        String wereda = getWereda(adminname);
        con = DB.getConn();
        try {
    ...
    public String getWereda(String uname) {
